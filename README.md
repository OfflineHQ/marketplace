...
In order to speed up the e2e test, we provide the users: <u>Alpha Admin</u> / <u>Beta Admin</u> / <u>Google User</u> whose account can be accessed directly with the `login` command located in `apps/web-e2e/commands.ts`.
