-- currency table
CREATE TABLE "public"."currency" ("value" text NOT NULL, PRIMARY KEY ("value"));
...
CREATE TRIGGER set_passPricing_updated_at BEFORE
UPDATE ON "public"."passPricing" FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();
-- passAmount table
CREATE TABLE "public"."passAmount" (
	...
	"maxAmountPerUser" integer CHECK (
		"maxAmountPerUser" IS NULL
