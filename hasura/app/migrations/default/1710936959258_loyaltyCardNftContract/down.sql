...
--
-- COMMENT ON COLUMN "public"."loyaltyCardParameters"."signingKey" IS E'Unique signing key used for secure operations related to the loyalty card.';
--
...
--   "updated_at" timestamptz NOT NULL DEFAULT now(),
--   "organizerId" text NOT NULL,
--   "loyaltyCardId" text NOT NULL REFERENCES "public"."loyaltyCardParameters"("loyaltyCardId") ON UPDATE NO ACTION ON DELETE NO ACTION,
