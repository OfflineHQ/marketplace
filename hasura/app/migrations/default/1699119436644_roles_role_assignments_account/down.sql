...
comment on column "public"."account"."isOrganizer" is E'An account can represent an user or organizer. It store essential informations and is used as the root class for relationships with other tables';
alter table "public"."account" alter column "isOrganizer" set default false;
alter table "public"."account" alter column "isOrganizer" drop not null;
alter table "public"."account" add column "isOrganizer" bool;

comment on column "public"."account"."organizerId" is E'An account can represent an user or organizer. It store essential informations and is used as the root class for relationships with other tables';
alter table "public"."account" alter column "organizerId" drop not null;
alter table "public"."account" add column "organizerId" text;
...
-- INSERT INTO "public"."roles" ("value") VALUES
...
-- $$;
--
-- -- Migration script for roleAssignments
...
-- COMMENT ON TABLE "public"."roleAssignments" IS 'Table to assign roles to accounts, allowing a many-to-many relationship. Each account can have multiple roles and each role can be assigned to multiple accounts. This is part of the RBAC system integration.';
--
-- select audit.audit_table(
--   '"roleAssignments"',
--   true,               -- audit_rows: Record each row change
