...
-- Create or modify packNftContractEventPass table
CREATE TABLE "public"."packNftContractEventPass"(
  ...
  PRIMARY KEY ("packNftContractId", "eventPassId")
);
...
COMMENT ON COLUMN "public"."packNftContractEventPass"."eventPassId" IS E'Identifier for the event pass. This field specifies which event pass is included in the pack, referring to a unique identifier within the eventPassNftContract table.';
