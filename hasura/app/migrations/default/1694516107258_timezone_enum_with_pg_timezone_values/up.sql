...
DECLARE 
   tz_name text;
BEGIN 
   FOR tz_name IN (SELECT name FROM pg_timezone_names WHERE name NOT LIKE 'posix/%') 
   LOOP
      INSERT INTO "public"."timezone" ("value") VALUES (tz_name) ON CONFLICT ("value") DO NOTHING;
   END LOOP;
END $$;
