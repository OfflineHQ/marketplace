...
const env = createEnv({
  server: {
    ...
    BYTESCALE_SECRET_API_KEY: z.string().min(1),
    UPLOAD_PATH_PREFIX: z.string().min(1),
    BYTESCALE_SECRET_JWT: z.string().min(1),
    BYTESCALE_PUBLIC_API_KEY: z.string().min(1),
    ...
    API_SECRET_ENCRYPTION_KEY: z.string().length(32),
    SHOPIFY_API_SECRET: z.string().length(32),
  },
  runtimeEnv: {
    APP: process.env.APP,
    ...
    BYTESCALE_SECRET_JWT: process.env.BYTESCALE_SECRET_JWT
      ? process.env.BYTESCALE_SECRET_JWT.replace(/\\n/g, '\n')
      : process.env.BYTESCALE_SECRET_JWT,
    BYTESCALE_PUBLIC_API_KEY: process.env.BYTESCALE_PUBLIC_API_KEY,
    ...
    API_SECRET_ENCRYPTION_KEY: process.env.API_SECRET_ENCRYPTION_KEY,
