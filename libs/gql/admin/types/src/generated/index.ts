...
export type GetEventsFromOrganizerIdQueryVariables = Types.Exact<{
  id: Types.Scalars['ID'];
  locale: Types.Locale;
  stage: Types.Stage;
}>;
...
export type GetOrganizerFromIdQueryVariables = Types.Exact<{
  id: Types.Scalars['ID'];
  stage: Types.Stage;
}>;


export type GetOrganizerFromIdQuery = { __typename?: 'query_root', organizer?: { __typename?: 'Organizer', id: string, slug: string, name: string, description?: { __typename?: 'OrganizerDescriptionRichText', json: any, references: Array<{ __typename: 'Asset', id: string, url: string, mimeType?: string | null }> } | null, image: { __typename?: 'Asset', url: string } } | null };
