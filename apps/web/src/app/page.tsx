    ...
    <>
      <section className="grid items-center gap-6 pb-8 pt-6 md:py-10">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0 md:flex-row">
          ...
          <pre className="hidden h-11 items-center justify-between space-x-2 overflow-x-auto rounded-lg border border-slate-100 bg-slate-100 pl-6 pr-2 dark:border-slate-700 dark:bg-black md:flex">
